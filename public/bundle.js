...
require.define("/node_modules/pde-engine/package.json",function(require,module,exports,__dirname,__filename,process){module.exports = {"main":"pde-engine.js"}});

require.define("/node_modules/pde-engine/pde-engine.js",function(require,module,exports,__dirname,__filename,process){
  ...
  function renderField () {
    ...
    for (row = 0; row < rows; ++row) {
      for (col = 0; col < cols; ++col) {
        ind = f[row][col] * field.scale | 0 // floor if > 0, ceil if < 0
