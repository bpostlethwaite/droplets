...
require.define("/node_modules/pde-engine/package.json",function(require,module,exports,__dirname,__filename,process){module.exports = {"main":"pdeEngine.js"}});

require.define("/node_modules/pde-engine/pdeEngine.js",function(require,module,exports,__dirname,__filename,process){
...
require.define("/lib/poissonSolver.js",function(require,module,exports,__dirname,__filename,process){/*jshint asi: true*/
...
require.define("/lib/entry.js",function(require,module,exports,__dirname,__filename,process){/*jshint asi: true*/
/*jshint laxcomma: true*/
"use strict";

var engine = require('pde-engine')
var poissonEngine = require('./poissonSolver.js')
...
// MODE FUNCTIONS ///////////////////////////////////////////////////
  ...
  function waveEqnMode() {
    ...
    canvas.addEventListener("click",function(evt) {
      ...
      field.addSource( (yp / ylen) | 0 , (xp / xlen) | 0 , cfg.mag)
    })
    // Set render configurations
    cfg.update = field.update
    cfg.scale = 10
    cfg.maxval = 40 // +/-
    cfg.adj = 40
  ...
  function diffusionEqnMode() {
    ...
    function tracedrops() {
      field.addSource( (ypix / ylen) | 0 , (xpix / xlen) | 0 , cfg.mag)
      socket.emit('clientDroplet', {
